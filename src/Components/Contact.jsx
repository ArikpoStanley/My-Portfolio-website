...
const Contact = () => {
    ...
    const feedback = {
      ...
      const handlesubmit =(e)=>{
        e.preventDefault()
        axios.post('http://localhost:3000/api/Contact', feedback)
      .then((response)=>{
  ...
  return (
    <div className='bg-[url("/src/assets/portfolio-img3.png")] '>
        ...
        <form method='POST' onSubmit={handlesubmit}data-aos="fade-down" data-aos-duration="1500" className='lg:w-1/2 w-full rounded-l-3xl bg-gradient-to-r from-fuchsia-800 via-indigo-700 to-transparent p-8 text-white flex flex-col ' action="/">
            ...
            <input type="submit" value='Send Message' className='p-2 shadow-black shadow-md rounded-3xl font-extrabold bg-gradient-to-r from-fuchsia-800 via-green-500 to-indigo-800 cursor-pointer hover:scale-110 duration-500 transition'/>
            </div>
        </form>
