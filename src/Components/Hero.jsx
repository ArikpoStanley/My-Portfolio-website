...
const Hero = () => {
  const download = async() =>{
    const blob = new Blob(["mycv.pdf"], {type: 'text'})
    const href = URL.createObjectURL(blob)
    const a = Object.assign(document.createElement("a"),{href, style: "display:none", download: "mycv.pdf"})
  ...
  return (
    ...
    <div  className='flex lg:flex-row flex-col-reverse justify-between px-0 bg-[url("/src/assets/portfolio-img1.png")] pt-16'>
      ...
      repeat={Infinity} className='text-blue-800 bg-white rounded-3xl px-2 text-3xl leading-[2]' sequence={[
            ...
            <div>
            <CountUp className='bg-clip-text  bg-gradient-to-r from-fuchsia-800 via-green-500 to-indigo-800 text-transparent text-6xl font-extrabold' start={0} end={7} duration={30} />
        ...
        <div className=' bg-gradient-to-r from-transparent  via-black to-transparent ' data-aos="fade-up-right" data-aos-duration="2000">
            <img className='lg:mx-0 mx-auto rounded-full' src={pic} alt="" />
